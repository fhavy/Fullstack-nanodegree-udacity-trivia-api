...
def create_app(test_config=None):
    # this is to create and configure the app
    app = Flask(__name__)
    setup_db(app)
    '''
    ...
    '''
    # An endpoint to handle GET categories route
    ...
    '''
    # and endpoint to GET Question and also use pagination
    ...
    '''
    # An endpoint to DELETE question
    @app.route('/questions/<int:id>', methods=['DELETE'])
    def deleting_question(id):
    ...
    # This is for Creating question using POST METHOD
    ...
    '''
    # This is to GET questions by a category
    @app.route('/categories/<int:category_id>/questions', methods=['GET'])
    def getting_the_questions_by_category(category_id):
        if request.method == "GET":
    ...
    #An endpoint to POST questions to play the quiz
