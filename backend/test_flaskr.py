...
class TriviaTestCase(unittest.TestCase):
    ...
    #this function test get categories
    ...
    # this function test get questions with a wrong page parameter
    ...
    # this function test delete a question with id 2
    ...
    # this function test detele a questions with a id that is not in the database
    ...
    # this function test create question
    ...
    # this fucntion test search with results
    ...
    # this function test get questions by category
...
# this Makes the tests conveniently executable
